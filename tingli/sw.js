...
// data-build: v2.28.3 (2026-09-19: значки частей — иероглифы в чипе: 句 фразы, 词 слова, 业 ДЗ, 文 текст + font-build: simsun-subset-STSong-1488 — маркер прекэша
...
const ASSETS = [
  ...
  './index.html',
  './manifest.json',
  './data/units.js?v=2.28.3',
  './data/extra.js?v=2.28.3',
  './data/idv.js?v=2.28.3',
  './data/biz.js?v=2.28.3',
  ...
  './fonts/simsun-subset.woff2?v=2.28.3',
