...
const ASSETS = [
  ...
  './index.html',
  './manifest.json',
  './data/units.js?v=2.31.1',
  './data/extra.js?v=2.31.1',
  './data/idv.js?v=2.31.1',
  './data/biz.js?v=2.31.1',
  ...
  './fonts/simsun-subset.woff2?v=2.31.1',
