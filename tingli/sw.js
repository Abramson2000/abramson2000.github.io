...
// data-build: v2.28.2 (2026-09-19: значки частей — 💬 фразы, 📘 слова, 📝 ДЗ (без цифр) + font-build: simsun-subset-STSong-1488 — маркер прекэша
...
const ASSETS = [
  ...
  './index.html',
  './manifest.json',
  './data/units.js?v=2.28.2',
  './data/extra.js?v=2.28.2',
  './data/idv.js?v=2.28.2',
  './data/biz.js?v=2.28.2',
  ...
  './fonts/simsun-subset.woff2?v=2.28.2',
