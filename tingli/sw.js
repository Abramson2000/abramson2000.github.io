...
const ASSETS = [
  ...
  './index.html',
  './manifest.json',
  './data/units.js?v=2.31.0',
  './data/extra.js?v=2.31.0',
  './data/idv.js?v=2.31.0',
  './data/biz.js?v=2.31.0',
  ...
  './fonts/simsun-subset.woff2?v=2.31.0',
