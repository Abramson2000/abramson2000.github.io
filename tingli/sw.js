...
// data-build: v2.30.0 (2026-09-19: значки частей — 话 диалог, 听 аудирование, 检 проверка; переименованы Подкасты 1/3/4/5/7, Урок 10, 初级 13/14 + font-build: simsun-subset-STSong-1488 — маркер прекэша
...
const ASSETS = [
  ...
  './index.html',
  './manifest.json',
  './data/units.js?v=2.30.0',
  './data/extra.js?v=2.30.0',
  './data/idv.js?v=2.30.0',
  './data/biz.js?v=2.30.0',
  ...
  './fonts/simsun-subset.woff2?v=2.30.0',
