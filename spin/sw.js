...
const CORE = [
  ...
  './app.js?v=crs101',
  './data.js?v=crs101',
  './meddicc-data.js?v=crs101',
  './spiced-data.js?v=crs101',
  './proactive-data.js?v=crs101',
  './boss-gate.js?v=crs101',
  './remote-sales-data.js?v=crs101',
  './supabase.min.js',
