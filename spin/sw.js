...
const CORE = [
  ...
  './app.js?v=crs100',
  './data.js?v=crs100',
  './meddicc-data.js?v=crs100',
  './spiced-data.js?v=crs100',
  './proactive-data.js?v=crs100',
  './boss-gate.js?v=crs100',
  './remote-sales-data.js?v=crs100',
  './supabase.min.js',
