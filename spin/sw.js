...
const CORE = [
  ...
  './app.js?v=crs102',
  './data.js?v=crs102',
  './meddicc-data.js?v=crs102',
  './spiced-data.js?v=crs102',
  './proactive-data.js?v=crs102',
  './boss-gate.js?v=crs102',
  './remote-sales-data.js?v=crs102',
  './supabase.min.js',
